          ...
          <div class="mb-12 flex flex-wrap justify-center">
            <div class="w-1/3 shrink-0 grow-0 basis-auto px-3  ">
              <div class="relative mb-10 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg">
                <img
                  src="https://drive.google.com/uc?id=19fvEIzoODGHyvYY2RXoa9Ti_8t5tbVJz"
                  class="w-full"
                  alt=""
                />
              </div>
            ...
            <div class="w-full shrink-0 grow-0 basis-auto px-3 md:w-8/12 xl:w-6/12">
              ...
              <p class="mb-6 ml-5 font-Fira_sans font-semibold">
                Increased Adoption: AR and VR technologies continue to gain
                traction across various industries, including gaming,
                entertainment, education, healthcare, and more. Many companies
                are exploring and implementing these technologies to enhance
                user experiences and improve productivity.
              </p>
              <button className="px-2 py-1 font-semibold bg-white border-2 border-black font-Fira_sans shadow-black rounded-xl">
                Read more
              </button>
            </div>
          </div>
